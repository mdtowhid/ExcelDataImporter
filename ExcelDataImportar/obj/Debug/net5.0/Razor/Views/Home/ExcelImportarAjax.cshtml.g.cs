#pragma checksum "C:\Users\hp\Documents\GitHub\ExcelDataImportar\ExcelDataImportar\Views\Home\ExcelImportarAjax.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "db7c7c20b04c178182eb677b8f20ef6b5bd2ac7e"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"db7c7c20b04c178182eb677b8f20ef6b5bd2ac7e", @"/Views/Home/ExcelImportarAjax.cshtml")]
...
#line 34 "C:\Users\hp\Documents\GitHub\ExcelDataImportar\ExcelDataImportar\Views\Home\ExcelImportarAjax.cshtml"
             Write(Url.Action("PreviewExcel","Home"));
...
#nullable disable
        ...
        Axios.postDataWithFile(url, importarDto, 'json', (data) => {
            if (!data.hasError) {
                ...
                let importarDto1 = {
                    auditDataList: list,
        ");
            WriteLiteral(@"            totalCount: list.length,
                };
        ...
        Axios.postDataWithFile(url, importarDto, 'json', (data) => {
            ...
            if (!data.hasError) {
                ...
                let importarDto1 = {
                    auditDataList: list,
                    t");
            WriteLiteral(@"otalCount: list.length,
                };
                let importarDto1Json = JSON.stringify(importarDto1);
                btnImport.classList.remove('d-none');
    ...
    btnImport.addEventListener('click', (e) => {
        previewGrid.innerHTML = `<i>Loading</>`;
        Axios.postDataWith");
            WriteLiteral(@"File(url, importarDto, 'json', (data) => {
            let options = ``;
            
            if (!data.hasError) {
                extractedData.forImport = true;
                let importarDto1Json = JSON.stringify(extractedData);
                previewGrid.innerHTML = `Data imported successfully`;
                previewGrid.classList.add('text-success');
            } else {
                previewGrid.classList.add('error');
                previewGrid.innerHTML = data.errorText;
            }
